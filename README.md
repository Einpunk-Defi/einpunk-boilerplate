...
🚀DEMO: https://einpunk-boilerplate-kuqf.vercel.app/

This boilerplate is built with [Einpunk](https://einpunk-boilerplate-kuqf-git-main-einstein-core.vercel.app/)

You need active web3 provider/wallet only for authnetication. All pages in this boilerplate do not require an active web3 provider, they use Moralis Web3 API. Einpunk supports the most popular blockchains and their test networks. You can find a list of all available networks in [Moralis Supported Chains](https://einpunk-boilerplate-kuqf-git-main-einstein-core.vercel.app/)

Please check the [official documentation of Einpunk](https://einpunk-boilerplate-kuqf-git-main-einstein-core.vercel.app/) for all the functionalities of Moralis.
...
If you need help with setting up the boilerplate or have other questions - don't hesitate to write in our community forum and we will check asap. [Forum link](https://t.me/einpunkUSD'). The best thing about this boilerplate is the super active community ready to help at any time! We help each other.
